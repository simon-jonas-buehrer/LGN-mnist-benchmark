"""Reload the trained checkpoint and evaluate it.

    uv run python load.py                 # loads the checkpoint, prints test metrics
"""
...
def load_model(ckpt_path: Path, device: str = "cpu") -> LUTNet:
    ...
    # Build with a placeholder thermometer; the real thresholds come from the state_dict.
...
def main() -> None:
    ...
    # Truth table of one neuron: its 4-entry boolean function.
